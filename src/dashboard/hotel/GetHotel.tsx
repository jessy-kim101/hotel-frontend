...
import  type { TIhotel } from '../../features/hotel/hotelApi';

const GetHotels = () => {
  // Replace 'hotelId' with a valid string or symbol, or fetch it from props/state/context
